...
const TodayHighlights = ({ weatherData, airQualityData }) => {
  ...
  return (
    ...
    >
      <div style={{ fontSize: "25px" }}>Today's Highlights</div>
      <div
        style={{
          display: "flex",
          gap: "18px",
      ...
      >
        ...
        >
          <div style={{ fontSize: "22px", }}>
            <p style={{paddingLeft:"20px"}}>Sunrise And Sunset</p>

            <div style={{ display: "flex", justifyContent: "space-between", padding: '10px' ,gap:"20px"}}>
              <div style={{
                alignItems: "center",
                display: "flex",
                justifyContent: "center",
              }}>
                <WbSunnyIcon style={{ fontSize: "40px", marginLeft: '10px' }} />
              ...
              <div style={{
                ...
                <NightsStayIcon style={{ fontSize: "40px", marginRight: '10px' }} />
