...
const MainWeatherCard = ({ weatherData }) => {
  ...
  return (
    <div style={{ backgroundColor: '#1F2A40', color: 'white', borderRadius: '0.5rem', width: '100%', padding: '30px' }}>
      ...
      <div style={{ marginTop: '1rem' }}>
        ...
        <div style={{ marginTop: '8px', display: 'flex', alignItems: 'center', fontSize: '14px' }}>
          <AccessTimeIcon style={{ marginRight: '5px', fontSize: '18px' }} />
          {currentTime}
        </div>
      </div>
    </div>
